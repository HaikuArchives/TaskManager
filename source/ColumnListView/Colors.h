...
#include <interface/GraphicsDefs.h>		// for rgb_color
#include <interface/InterfaceDefs.h>	// for color_which
#include "Color.h"

// OBSOLETE! Use CColor instead!
...
const rgb_color BeMenuSelectGrey =		{152,152,152,	255};
